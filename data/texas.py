...
class Texas:
    def __init__(self):
        # Load dataset
        data = np.load("/home/test/FRL/data/texas100.npz")
        ...
        rand_idx = torch.randperm(features.size(0))
        ...
        # Create datasets
        train_dataset = TexasDataset(features=train_features, labels=train_labels, transform=Mytransform)
        test_dataset = TexasDataset(features=test_features, labels=test_labels, transform=Mytransform)
