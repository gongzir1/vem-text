...
#         print ("number of total training points:" ,tr_count)
        ...
        if args.FL_type =="FRL_fang" or args.FL_type =="FRL_defense_Fang"or args.FL_type =='other_attacks_Fang'or args.FL_type =='FRL_label_flip_fang'or args.FL_type =='Reverse_mid_val'or args.FL_type =='Reverse_mid_certified':
