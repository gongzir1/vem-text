...
class EMNIST:
    def __init__(self):
        ...
        train_dataset = datasets.EMNIST(root=args.data_loc, split="bymerge",train=True, download=True, transform=Mytransform)

        test_dataset = datasets.EMNIST(root=args.data_loc, split="bymerge", train=False, download=True, transform=Mytransform)
        
        args.output_size = len(train_dataset.classes)
