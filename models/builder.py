...
class Builder(object):
    def __init__(self):
        ...
        self.fc_layer=getattr(modules, args.conv_type)
    ...
    def fc(self, in_features, out_features, bias=True):
        """Fully connected layer (linear layer)"""
        layer = self.fc_layer(in_features, out_features, bias=bias)
        self.conv_init(layer)  # Optionally apply the same initialization as convs
        return layer
   
    def batchnorm1d(self, planes):
